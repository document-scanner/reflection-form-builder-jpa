...
public class EntityValidator {
    ...
    public boolean handleWarnings(Object instance) {
        ...
        if(warningHandler == null) {
            ...
            Collections.sort(warningHandlerClasses,
                    ReflectionFormBuilderUtils.CLASS_COMPARATOR_SUBCLASS_FIRST);
     ...
     * @throws EntityValidationException indicates that the validation fails and
     *     encapsulates information about the reason
     */
